import{s,n as o}from"../chunks/scheduler.FdFjnjtv.js";import{S as r,i as l,e as h,c,y as d,o as m,g as f,d as u}from"../chunks/index.vSXNCIm6.js";const p=""+new URL("../assets/celltower.qNSZMDa-.svg",import.meta.url).href;function w(n){let e,i=`<div class="content"><img src="${p}"/> <center><h1>Website Title</h1> <h2>8th YTP 壹伍伍捌</h2></center> <h1>Purpose of this website</h1>
...
<br/> <h3>The history of RAN</h3> <dl><dt>0G</dt><dd>After World War II, wireless telephones became available to the general public. The era before cellular networks, often referred to as 0G, marked the advent of commercial wireless communication. Unlike earlier closed telephone systems, 0G represented a significant advancement as it was accessible as a commercial service. These early wireless phones were typically installed in cars or trucks, paving the way for greater mobility and accessibility in telecommunications.
  ...
  </dd><dt>5G</dt><dd></dd></dl></div>`;return{c(){e=h("html"),e.innerHTML=i,this.h()},l(t){e=c(t,"HTML",{lang:!0,"data-svelte-h":!0}),d(e)!=="svelte-1nevxhf"&&(e.innerHTML=i),this.h()},h(){m(e,"lang","en")},m(t,a){f(t,e,a)},p:o,i:o,o,d(t){t&&u(e)}}}class b extends r{constructor(e){super(),l(this,e,null,w,s,{})}}export{b as component};
